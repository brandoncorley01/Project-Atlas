...
export const CLIENT_EARNINGS_DESK = {
  upcoming: [
    {
      symbol: "AAPL",
  ...
  watchlist: [
    { symbol: "AAPL", report_date: "2026-08-10", phase: "PRE_EARNINGS", note: "Active earnings watch" },
    { symbol: "COST", report_date: "2026-08-04", phase: "POST_RELEASE_UNCONFIRMED", note: "Active earnings watch" },
  ],
  pre_earnings: [],
  post_earnings: [],
  micro_coattails: [
    {
      symbol: "AAPL",
      recommendation: "MICRO_COATTAIL",
      direction: "neutral",
      phase: "PRE_EARNINGS",
      strategy: "debit_spread",
      confidence: 63,
      expected_move_pct: 7.4,
      historical_avg_move_pct: 8.0,
      estimated_iv_crush_pct: 31,
      breakeven_pct: 6.1,
      ...
      entry_condition: "Enter only if spread mid is within 5% of evaluated mark.",
      invalidation_condition: "Break of pre-earnings support.",
      profit_targets: ["Close 50% at +40% of debit"],
      expected_holding_period: "Through print + 1 session",
      watching: ["IV crush realization", "Sector confirmation"],
